...
export function composeIssueBody({ feedbackId, submittedAt, description, triage, photoCount = 0 }) {
  ...
  const footnotes = [
    ...
    // Never lets the issue imply a maintainer vouched for any of this. Nobody
    // read it before it was filed, and someone deciding how much weight to give
    // the analysis needs to know that.
